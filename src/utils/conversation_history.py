...
This module provides functionality to manage conversation history for the Deep Research Agent,
allowing users to reference past conversations and maintain context across sessions.
...
class Conversation:
    ...
    def get_context_summary(self, max_messages: int = 5) -> str:
        ...
        for msg in recent_messages:
            ...
            context_lines.append(f"{role_emoji} {msg.role}: {msg.content[:200]}{'...' if len(msg.content) > 200 else ''}")
...
class ConversationHistory:
    ...
    def create_conversation(self, title: str, initial_message: Optional[str] = None) -> str:
    ...
    def search_conversations(self, query: str, max_results: int = 10) -> List[Conversation]:
        ...
        for conversation in self.conversations.values():
            if (query_lower in conversation.title.lower() or 
                query_lower in conversation.get_searchable_content().lower()):
